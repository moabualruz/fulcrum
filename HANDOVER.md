...
│                              fulcrum-upstream/<name>/; verifies subpath_sha256
...
- **graphify does not list Pi as a supported agent.** Init falls back to file-copy via `fulcrum-upstream/graphify/`.
