...
description: "The Product Manager is the L2 specialist that maintains the roadmap, prioritises the epic and issue backlog, and writes strategic decision memories. It owns scope calls, trade-off documentation, and t"
