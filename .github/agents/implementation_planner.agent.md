...
description: "The Implementation Planner is the L2 specialist that turns an approved PRD into an executable sequence of tasks. It decomposes the work into atomic units with clear done-criteria, rough effort estimat"
