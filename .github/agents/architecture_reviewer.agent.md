...
description: "The Architecture Reviewer is the L2 read-only gate that reviews system designs, PRDs, and implementation plans for architectural soundness before implementation begins. It identifies coupling, unknown"
