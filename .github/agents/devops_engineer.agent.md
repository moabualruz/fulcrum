...
description: "The DevOps Engineer is the L2 specialist that owns infrastructure, CI/CD, deployments, monitoring, and incident response. It writes infrastructure-as-code (Terraform or Pulumi), maintains GitHub Actio"
