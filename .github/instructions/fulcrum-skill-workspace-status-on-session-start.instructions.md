---
applyTo: "**"
description: "Fulcrum skill: Fetch workspace status at session start — running agents, WIP budget, blocked runs. Before starting new run or responding to user request."
---
