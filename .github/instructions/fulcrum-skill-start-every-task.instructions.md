---
applyTo: "**"
description: "Fulcrum skill: Register agent run before touching code. Applies before first Write/Edit/MultiEdit/Bash in session, or when targeted by team invocation."
---

---
name: start-every-task
description: Register agent run before touching code. Applies before first Write/Edit/MultiEdit/Bash in session, or when targeted by team invocation.
---
