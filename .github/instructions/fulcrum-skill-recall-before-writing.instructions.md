---
applyTo: "**"
description: "Fulcrum skill: Query Fulcrum memory before writing new code, docs, or architectural decisions. Applies before producing novel output on a topic project may have prior context on."
---

---
name: recall-before-writing
description: Query Fulcrum memory before writing new code, docs, or architectural decisions. Applies before producing novel output on a topic project may have prior context on.
---
