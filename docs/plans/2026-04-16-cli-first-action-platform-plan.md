...
- [x] Task 1: Define canonical action metadata types and registry helpers
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/tool-registry.test.ts`
...
- [x] Task 2: Add registry-level compatibility aliases for legacy MCP-oriented names where needed
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/tool-registry.test.ts src/tests/mcp-server.test.ts`
...
- [x] Task 3: Implement `fulcrum action list` and `fulcrum action exec`
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/cli-coverage.test.ts`
...
- [x] Task 4: Make `fulcrum tool list/exec` a compatibility alias over the same action executor
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/cli-coverage.test.ts src/tests/tool-registry.test.ts`
...
- [x] Task 5: Update readiness/helper responses to return CLI-first next actions
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/serve-mcp-monitor.test.ts src/tests/mcp-server.test.ts`
...
- [x] Task 6: Replace `buildProfileFilter` with rule-driven MCP exposure planning
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/mcp-server.test.ts`
...
- [x] Task 8: Route plugin MCP exposure through the same planner
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/plugin-mcp-tools.test.ts src/tests/mcp-server.test.ts`
...
- [x] Task 9: Replace plugin `tools` registration with action-native registration
  ...
  - Verify: `pnpm --filter fulcrum-cli vitest run src/tests/plugin-mcp-tools.test.ts`
...
- [x] Task 15: Run focused and full verification
  ...
  - Verify: `pnpm --filter fulcrum-cli test` and `pnpm test`
