...
### Step 11 — Authored skills (29 per detected agent)
...
| upstream skill count < 19 | `fulcrum skills upstream` failed (integrity mismatch or network). Re-run with debug. See HANDOVER.md §6.0b. |
