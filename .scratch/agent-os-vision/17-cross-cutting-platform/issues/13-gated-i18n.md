...
- [ ] Locale persists: `TenantSetting` key `web.locale` written; next SSR honours it.
...
- Issue 01 (schema) — `TenantSetting` needed to store locale.
