...
description: >-
  Writes technical documentation, API references, READMEs, and user guides.
model: claude-sonnet-4-6
tools: ["Read", "Glob", "Grep", "Write", "Edit", "list_tasks", "create_task", "update_task", "recall_memory", "write_memory", "start_agent_run", "heartbeat_agent_run", "complete_agent_run", "block_agent_run", "get_agent_run_status", "get_workspace_status", "build_cos_context"]
---
