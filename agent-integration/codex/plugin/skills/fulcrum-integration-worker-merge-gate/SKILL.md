---
name: fulcrum-integration-worker-merge-gate
description: >-
  When operating as integration_worker, verify review and test artifacts exist
  before calling processMergeQueue. Applies to every merge attempt by the
  integration_worker role.
---
