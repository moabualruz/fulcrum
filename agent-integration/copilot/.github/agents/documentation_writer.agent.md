...
description: "The Documentation Writer is the L2 specialist that writes and maintains user-facing docs — READMEs, getting-started guides, API references, examples, and tutorials. It keeps docs in sync with code by "
