---
applyTo: "**"
description: "Fulcrum skill: Never include credentials, API keys, tokens, passwords in tool inputs or memory writes. Every tool call accepting free-form text."
---

---
name: secret-hygiene
description: Never include credentials, API keys, tokens, passwords in tool inputs or memory writes. Every tool call accepting free-form text.
---
