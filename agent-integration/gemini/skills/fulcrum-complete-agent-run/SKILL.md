---
name: fulcrum-complete-agent-run
description: >-
  Finalize an agent run with a meaningful summary and changed-file list. Applies
  whenever you finish work, hand off, or are about to stop responding on a run
  you started.
---
