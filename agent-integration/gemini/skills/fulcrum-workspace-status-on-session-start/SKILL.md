---
name: fulcrum-workspace-status-on-session-start
description: >-
  Fetch workspace status at the start of every session to see running agents,
  WIP budget, and blocked runs. Applies before you start any new run or respond
  to a user request in a Fulcrum workspace.
---
