---
name: fulcrum-invoke-team-only-from-cos
description: >-
  Only chief_of_staff may call invoke_team. Applies whenever a non-CoS role is
  about to call fulcrum action exec invoke_team — escalate instead of attempting
  the call.
---
