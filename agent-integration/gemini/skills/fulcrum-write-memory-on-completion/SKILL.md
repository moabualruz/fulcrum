...
description: >-
  Persist a memory after completing any task that involved a decision,
  trade-off, or surprising finding. Applies after complete_agent_run when the
  work produced durable knowledge.
---
