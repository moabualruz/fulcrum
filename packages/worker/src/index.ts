...
export { claudeCodeAdapter, dispatchClaudeCode, findClaudeBin } from './adapters/claude-code.js'
export type { DispatchClaudeCodeInput } from './adapters/claude-code.js'
export type {
  AgentAdapter,
  SpawnContext,
  SpawnAgentInput,
