...
describe('Task.assigned_run_id', () => {
  ...
  it('can be set via updateTask', async () => {
    ...
    const updated = await updateTask({ workspace_id: 'ws_1', task_id: task.task_id, assigned_run_id: 'run_abc123' })
  ...
  it('can be cleared back to null via updateTask', async () => {
    ...
    const cleared = await updateTask({ workspace_id: 'ws_1', task_id: task.task_id, assigned_run_id: null })
