...
export async function writeMemoryFile(vaultPath: string, memory: FullMemory): Promise<string> {
  // L0 stores the ORIGINAL human-readable content verbatim. (Memory v3
  // PR 9.3 retired the canonical_text column — the vault body is now the
  // single source of truth for a memory's text.)
