...
// Used by PR 2's runStagedSearch to age out long-untouched memories. All
// behavior is data-driven via the TemporalDecayConfig record; default
// config keeps decay disabled so the lift is a no-op until PR 2 wires it up.
