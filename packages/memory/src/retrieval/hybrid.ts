...
// temporal-decay and MMR diversity reranking. PR 2's runStagedSearch composes
// this on top of the RRF stage.

import { applyMMRToHybridResults, type MMRConfig, DEFAULT_MMR_CONFIG } from '../scoring/mmr.js'
import {
