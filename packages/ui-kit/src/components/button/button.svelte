	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				// Compatibility aliases for pre-DESIGN.md §4.1 callers. New usage should prefer primary/danger.
			...
			size: {
				...
				"icon-lg": "size-10",
				// Compatibility alias for pre-DESIGN.md §4.1 callers. New usage should prefer md.
				default:
