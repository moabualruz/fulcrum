...
// The CLI (or any host that depends on both fulcrum-agent-core and fulcrum-teams)
// calls setTeamOps(createTeamOps()) once at startup to register the implementation.

import type { TeamOps } from 'fulcrum-agent-core'
...
export function createTeamOps(): TeamOps {
  ...
  // return types so fulcrum-agent-core stays free of a fulcrum-teams dependency.
