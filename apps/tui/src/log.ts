...
/**
 * Thin formatter that scrubs sensitive keys/headers before any TUI text
 * reaches stdout / stderr / crashlog. Mirror of `apps/cli/src/log.ts`.
 */
...
export function installTuiLogRedaction(): void {
	if (installed) return;
	installed = true;
