...
describe("FieldDependencyEval — Phase 05", () => {
  ...
  it("hide action hides target and removes from required", () => {
    ...
    // Both rules match — hide comes after require, so hide wins
  ...
  it("missing field value treated as empty string", () => {
    ...
    // type field missing from values → coerced to ""
  ...
  it("conflicting show then hide — last rule wins", () => {
    ...
    // hide processed after show → hidden wins
