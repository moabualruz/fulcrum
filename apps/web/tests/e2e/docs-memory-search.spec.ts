/**
 * E2E: knowledge workflow — Documents, Memory, Search integration.
 *
 ...
 *
 * Run via:
 *   cd apps/web && bunx playwright test tests/e2e/docs-memory-search.spec.ts
 */
...
if (isPlaywrightCli) {
  ...
  test.describe("knowledge workflow — Documents", () => {
  ...
  test.describe("knowledge workflow — Memory Browser", () => {
  ...
  test.describe("knowledge workflow — Search Page", () => {
  ...
  test.describe("knowledge workflow — Cmd+K Palette", () => {
