...
/** @deprecated Use `isPublicApiEnabled` from `apps/server/src/api/feature-flags.ts`. */
export { isPublicApiEnabled as _isPublicApiEnabled } from "@fulcrum/server/api/feature-flags.ts";
