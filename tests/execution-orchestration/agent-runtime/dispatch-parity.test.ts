/**
 * runtime workflow integration tests — Dispatch Parity (CLI/tRPC/TUI/Web).
 *
...
import { AgentRunOrchestrationStateSchema } from "@execution-orchestration/infrastructure/agent-runtime/symphony/schemas.ts";

const validUuid = "a1234567-89ab-4def-8123-456789abcdef";

describe("runtime workflow: Dispatch Parity — CLI/tRPC/TUI/Web", () => {
