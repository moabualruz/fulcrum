/**
 * runtime workflow integration tests — App-Server Client (JSONL protocol).
 *
...
} from "@execution-orchestration/infrastructure/agent-runtime/symphony/app-server-protocol.ts";
import { TokenUsageAggregator } from "@execution-orchestration/infrastructure/agent-runtime/token-tracking.ts";

describe("runtime workflow: App-Server Client — JSONL Protocol", () => {
  // --- parseMessage ---
