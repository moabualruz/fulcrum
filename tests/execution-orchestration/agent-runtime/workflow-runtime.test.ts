/**
 * runtime workflow integration tests — Workflow Runtime (orchestrator lifecycle).
 *
...
import { calcRetryDelay, type RunRef } from "@execution-orchestration/infrastructure/agent-runtime/symphony/retry.ts";
import {
  WorkflowConfigSchema,
  type WorkflowConfig,
} from "@execution-orchestration/infrastructure/agent-runtime/symphony/schemas.ts";
import { ClaimConflictError } from "@execution-orchestration/infrastructure/agent-runtime/symphony/orchestrator.ts";
import { StallScanTimeoutError } from "@execution-orchestration/infrastructure/agent-runtime/symphony/stall.ts";

describe("runtime workflow: Workflow Runtime — Orchestrator Lifecycle", () => {
  // --- State Machine ---
