/**
 * runtime workflow integration tests — Tracker Model (SymphonyIssueSchema).
 *
...
import { TrackerBlockerResolutionError } from "@execution-orchestration/infrastructure/agent-runtime/symphony/tracker.ts";
...
describe("runtime workflow: Tracker Model — SymphonyIssueSchema", () => {
