...
const ARCHITECTURE_DOMAIN_COMMANDS = [
  "i18n",
  "theme",
  "telemetry",
  "backup",
...
describe("architecture all-domain CLI coverage gate", () => {
  test("all required CLI domains are mounted or generated", async () => {
    ...
    const missing = [...BASE_DOMAINS, ...ARCHITECTURE_DOMAIN_COMMANDS].filter((domain) =>
