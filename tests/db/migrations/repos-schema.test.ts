...
import { Migration20260502070500_artifacts_edges } from "@platform-core/infrastructure/application-database/migrations/Migration20260502070500_artifacts_edges.ts";
import { Migration20260502080000_inference_cache_schema } from "@platform-core/infrastructure/application-database/migrations/Migration20260502080000_inference_cache_schema.ts";
...
import { Migration20260502090100_agent_runs_claimed_by } from "@platform-core/infrastructure/application-database/migrations/Migration20260502090100_agent_runs_claimed_by.ts";
import { Migration20260502090200_memory_context_core } from "@platform-core/infrastructure/application-database/migrations/Migration20260502090200_memory_context_core.ts";
import { Migration20260502090300_sprints_schema } from "@platform-core/infrastructure/application-database/migrations/Migration20260502090300_sprints_schema.ts";
import { Migration20260502095500_saved_views } from "@platform-core/infrastructure/application-database/migrations/Migration20260502095500_saved_views.ts";
import { Migration20260502100000_memory_heuristic_dedup_constraints } from "@platform-core/infrastructure/application-database/migrations/Migration20260502100000_memory_heuristic_dedup_constraints.ts";
import { Migration20260502110000_repos_git } from "@platform-core/infrastructure/application-database/migrations/Migration20260502110000_repos_git.ts";
