...
> Command dispatch and per-feature CLI surfaces for the `fulcrum` binary. Entry point is `src/index.ts`; this directory hosts every subcommand handler and its tests.
