 ...
 *
 * Pillar 8, Issue 05: receives doc body + frontmatter from Pillar 7's doc-save
 * event, runs three extraction passes, persists Memory + MemoryLink entities.
 *
 * Three passes:
 ...
 *
 * C1: gated behind FULCRUM_FEATURES (feature flag); hook itself is always built.
 * C2: org_id + project_id from ctx.
 */
...
import type { MemoryImportance, MemoryKind } from "../../db/entities/memory/enums.ts";
