/**
 * Gated LLM-driven memory extractor — Pillar 8, Issue 15.
 *
 ...
 * events. Calls Pillar 2 inference sidecar extract_facts(text) → Fact[].
 *
 ...
 *
 * C1: gated behind FULCRUM_FEATURES flag.
 * C2: org_id scoped; source='llm'.
 */
...
import type { MemoryImportance, MemoryKind, MemoryLinkTargetKind } from "../db/entities/memory/enums.ts";
