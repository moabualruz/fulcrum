...
// ── TSK-13: Round-trip, AND/OR, custom fields, all operators ───────────────

describe("SavedViewQuery round-trip (TSK-13)", () => {
  /**
...
describe("AND/OR combinator patterns (TSK-13)", () => {
...
describe("custom field reference filters (D-72, TSK-13)", () => {
