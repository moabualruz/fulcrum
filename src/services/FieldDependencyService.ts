/**
 * FieldDependencyService — Phase 05 Plan 12 (D-111, HIGH-03).
 *
 * Server-side field dependency validation and CRUD.
 * Called by TaskService.create/update to enforce required-field rules,
...
export class FieldDependencyService {
   ...
   * Throws TRPCError (BAD_REQUEST) if any required fields are missing.
   *
