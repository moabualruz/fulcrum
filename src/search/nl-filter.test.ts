/**
 * P11#16 — NL→filter translation tests.
 * RED→GREEN: NL→filter OFF → plain-text pass-through; ON + sidecar mock → AST
 * injected; sidecar timeout → plain-text fallback, no error.
 */
