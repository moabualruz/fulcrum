...
export class ContextAssembler {
  constructor(
    private readonly retriever: MemoryRetrieverPort = inject(MemoryRetriever),
    private readonly taskRepository: FindOneOrFailPort = inject(TaskRepository),
    private readonly documentRepository: FindPort = inject(DocumentRepository),
    private readonly runRepository: FindPort = inject(AgentRunRepository),
    private readonly snapshotWriterOrEm: SnapshotWriterPort | EntityManager = inject(ENTITY_MANAGER_TOKEN),
    private readonly repoRepository: FindOnePort = inject(RepoRepository),
    private readonly skillRepository: FindPort = inject(FulcrumSkillRepository),
  ) {}
