/**
 * Phase 04 — Backend probes: BackendHealth status, probe contract, embedded auto-spawn.
 */
import { describe, expect, test } from "bun:test";
import { probeConfiguredBackends, getAllBackendIds, type BackendHealth } from "../inference/backend-probes.ts";
