...
type PageProps = {
  data: {
    streamed: {
      ...
      models: Promise<Array<{ id: string; kind: string; downloaded: boolean; active: boolean }>>
        | Array<{ id: string; kind: string; downloaded: boolean; active: boolean }>;
    };
  };
  form?: {
    success?: boolean;
...
const data: PageProps["data"] = {
  streamed: {
    ...
    models: [{ id: "BAAI/bge-small-en-v1.5", kind: "embed", downloaded: true, active: true }],
  },
};
