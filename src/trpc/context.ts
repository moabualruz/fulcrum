...
export interface TRPCContext {
  ...
  /** Request correlation id, generated by request-id middleware on first procedure hit. */
  requestId: string | null;

  /** Fetch adapter response headers. Null for in-process CLI/TUI callers. */
...
export function ensureRequestId(ctx: TRPCContext): string {
  ...
  ctx.responseHeaders?.set(FULCRUM_REQUEST_ID_HEADER, ctx.requestId);
