...
import * as taskCommands from "@work-management/application/tasks/commands.ts";
import * as taskQueries from "@work-management/application/tasks/queries.ts";
import * as docCommands from "@knowledge-workspace/application/docs/commands.ts";
import * as docQueries from "@knowledge-workspace/application/docs/queries.ts";
import * as sprintCommands from "@work-management/application/sprints/commands.ts";
import * as sprintQueries from "@work-management/application/sprints/queries.ts";
import * as reportCommands from "@work-management/application/reports/commands.ts";
import * as reportQueries from "@work-management/application/reports/queries.ts";
import * as runCommands from "@execution-orchestration/application/runs/commands.ts";
import * as runQueries from "@execution-orchestration/application/runs/queries.ts";
import * as artifactCommands from "@workflow-coordination/application/artifacts/commands.ts";
import * as artifactQueries from "@workflow-coordination/application/artifacts/queries.ts";
