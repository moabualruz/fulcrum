...
- **Adapter** — surface-specific executor module under `services/platform-core/src/application/component-lifecycle/adapters/`. One per `SurfaceKind` family.
...
Context-scoped decisions will live under `services/platform-core/src/application/component-lifecycle/docs/adr/` when recorded. None recorded yet; create the directory lazily from `docs/adr/0000-template.md`.
