/**
 * routing workflow — Skill registry: MCP virtual skills, conflict detection, lock enforcement.
 */
import { describe, expect, test } from "bun:test";
import { createHash } from "node:crypto";
import { McpVirtualSkill } from "@platform-core/infrastructure/application-database/entities/skills/McpVirtualSkill.ts";
