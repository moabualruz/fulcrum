/**
 * keyring.ts — OS keyring abstraction with encrypted-file fallback.
 *
 * Priority:
...
/** DI token for SecretsKeyring — bound by the host (tRPC server, CLI, TUI). */
export const SecretsKeyringToken = "SecretsKeyringToken" as const;
 ...
 * then degrade to the fallback file. Never throws.
 */
