 ...
 *
 * Probe adapters for embedded, ollama, lm-studio, and OpenAI-compatible
 * endpoints must emit the typed state expected by the service contract.
 */
...
//
// Each probe checks whether its backend is configured and reachable.
// Unconfigured backends report `unconfigured`.
// ---------------------------------------------------------------------------
