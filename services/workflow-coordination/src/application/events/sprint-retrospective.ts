...
} from "@workflow-coordination/application/events/commands.ts";
 ...
 * @param docsCreate - Optional document creation function. If null, creates the
 *   document directly through the event handler persistence boundary.
 */
