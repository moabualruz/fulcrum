...
export interface RepoDto { id: string; orgId: string; slug: string; name: string; kind: string; localPath: string | null; remoteUrl?: string | null; defaultBranch?: string | null; currentBranch?: string | null; lastSyncAt?: Date | null; syncStatus?: string | null; lastTouchedAt?: Date | null; archived?: boolean }
