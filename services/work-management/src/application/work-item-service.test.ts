/**
 * WorkItemService tests — bulk operations, custom fields, label/priority model.
...
describe("WorkItemService - bulk operations (TSK-11, D-75)", () => {
  it("bulk updates 50+ tasks in single transaction", async () => {
    ...
    const svc = new WorkItemService(em);
...
describe("WorkItemService - custom field types round-trip (TSK-12, D-77)", () => {
  /**
...
// ── WorkItemService - watchers (carried from initial RED stub) ─────────────────

describe("WorkItemService - watchers", () => {
  it("auto-subscribes task creator as watcher", () => {
    // Verified by the automation workflow tests; this test serves as a regression guard.
