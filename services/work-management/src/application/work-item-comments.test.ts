/**
 * WorkItemCommentService unit tests.
 *
...
import { WorkItemCommentService, type TipTapNode } from "@work-management/application/work-item-comments.ts";
...
describe("WorkItemCommentService - extractMentions", () => {
...
describe("WorkItemCommentService - createComment", () => {
...
describe("WorkItemCommentService - createReply", () => {
...
describe("WorkItemCommentService - resolve / unresolve", () => {
  it("reports missing comments as application not-found errors", async () => {
    const { service } = makeService();
    await expect(service.resolveComment(ORG_ID, "missing", USER_A)).rejects.toBeInstanceOf(AppNotFoundError);
    await expect(service.unresolveComment(ORG_ID, "missing")).rejects.toBeInstanceOf(AppNotFoundError);
  });
...
describe("WorkItemCommentService - reactions", () => {
  it("reports duplicate reactions as application conflicts", async () => {
...
describe("WorkItemCommentService - subscribe idempotency", () => {
...
describe("WorkItemCommentService - getThreaded", () => {
...
describe("WorkItemCommentService - deleteComment", () => {
  it("reports missing comments as application not-found errors", async () => {
    const { service } = makeService();
    await expect(service.deleteComment(ORG_ID, "missing")).rejects.toBeInstanceOf(AppNotFoundError);
  });
