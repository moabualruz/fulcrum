 ...
 *
 * All queries filter by org_id from authenticated context. Parameterized
 * queries prevent user input from being interpolated into SQL, and request
 * limits are capped by the router schema.
 */
...
export class SearchQueryService {
  ...
  async query(orgId: string, input: SearchQueryInput): Promise<SearchQueryOutput> {
    ...
    // Empty term guard prevents accidental full-table scans.
    ...
    // All filters use parameterized placeholders.
