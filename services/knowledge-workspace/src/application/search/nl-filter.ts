/**
 * Natural-language filter translation via inference sidecar.
 *
 ...
 * SavedViewQuery from the work-management saved-view filter boundary.
 *
 * Sidecar timeout (5s) → plain-text pass-through fallback.
 * No separate query path — AST injected into standard search.query call.
 */

import { type SavedViewQuery, SavedViewQuerySchema } from "@work-management/application/saved-views/filter-query.ts";
